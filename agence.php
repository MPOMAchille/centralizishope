                  ...
                  <ul class="list-unstyled components">
                     ...
                     <li>
                        ...
                        <ul class="collapse list-unstyled" id="element">
                           ...
                           <li><a href="agence.php?page=<?php echo base64_encode('pages/immig/lister_imm');?>">> <span>Postulants</span></a></li>

                           <li><a href="pages/bord/liste_candidats8.php">> <span>Dossiers</span></a></li>


                           <li><a href="agence.php?page=<?php echo base64_encode('pages/bord/cv222');?>">> <span>Compétences Clients</span></a></li>
                     ...
                     <li>
                        ...
                        <ul class="collapse list-unstyled" id="elementi">
                           <li><a href="agence.php?page=<?php echo base64_encode('pages/bord/offre');?>">> <span>Enregistrer</span></a></li>
                           <li><a href="agence.php?page=<?php echo base64_encode('pages/bord/listeroffre');?>">> <span>Lister les Offres</span></a></li>
                           <li><a href="agence.php?page=<?php echo base64_encode('pages/bord/listercandidat');?>">> <span>Candidats</span></a></li>
                     ...
                     <li><a href="agence.php?page=<?php echo base64_encode('pages/bord/produitss');?>"><i class="fa fa-shopping-cart blue1_color"></i> <span>MarketPlace</span></a></li>
