         ...
         <ul class="list-unstyled components">
            <li class="active">
               ...
               <ul class="collapse list-unstyled" id="dashboard">
                  <li>
                     <a href="agent.php?page=<?php echo base64_encode('pages/bord/lister');?>">> <span>Tableau de bord 1</span></a>
                  </li>
                  <li>
                     <a href="agent.php?page=<?php echo base64_encode('pages/bord/lister');?>">> <span>Tableau de bord 2</span></a>
                  </li>
               </ul>
            </li>
            <li><a href="#"><i class="fa fa-group blue1_color"></i> <span>Prestataires</span></a></li>
            <!-- Compétences -->
            <li><a href="agent.php?page=<?php echo base64_encode('pages/immig/ajout2');?>"><i class="fa fa-graduation-cap orange_color"></i> <span>Ajouter un agent</span></a></li>
            <!-- Emplois -->
            <li><a href="agent.php?page=<?php echo base64_encode('pages/bord/lister_offre');?>"><i class="fa fa-briefcase green_color"></i> <span>Emplois</span></a></li>
            <li>
               <!-- Immigration -->
               <a href="#element" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="fa fa-plane purple_color"></i> <span>Immigration</span></a>
               <ul class="collapse list-unstyled" id="element">
                  <li><a href="agent.php?page=<?php echo base64_encode('pages/bord/lister');?>">> <span>identification personnelle</span></a></li>
                  <li><a href="agent.php?page=<?php echo base64_encode('pages/bord/lister');?>">> <span>paiement et acheminement des documents</span></a></li>
                  <li><a href="agent.php?page=<?php echo base64_encode('pages/bord/lister');?>">> <span>approbation du agent</span></a></li>
                  <li><a href="agent.php?page=<?php echo base64_encode('pages/bord/lister');?>">> <span>paiement et début de la procédure</span></a></li>

                  <li><a href="agent.php?page=<?php echo base64_encode('pages/bord/test');?>">> <span>Test</span></a></li>
               </ul>
            </li>
            <li>
               <!-- Messages -->
               <a href="pages/bord/message.php" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="fa fa-comments-o red_color"></i> <span>Messages</span></a>
            ...
            <li><a href="#"><i class="fa fa-shopping-cart blue1_color"></i> <span>E-commerce</span></a></li>
         </ul>
      </div>
   </div>
</nav>
                              ...
                              <ul class="user_profile_dd">
                                 <li>
                                    ...
                                    <div class="dropdown-menu">
                                       <a class="dropdown-item" href="agent.php?page=<?php echo base64_encode('pages/bord/profil');?>">Mon Profil</a>
                                       <a class="dropdown-item" href="agent.php?page=<?php echo base64_encode('pages/bord/profil');?>">Paramètres</a>
...
<section class="content">
        <div class="container-fluid">
           ...
           <?php 
            ...
            {
            include('pages/bord/lister_agent.php');
            }
              ?>
            <!-- Invoice Example -->
