         ...
         <ul class="list-unstyled components">
            <li class="active">
               ...
               <ul class="collapse list-unstyled" id="dashboard">
                  <li>
                     <a href="candidat.php?page=<?php echo base64_encode('pages/bord/lister');?>">> <span>Tableau de bord 1</span></a>
                  </li>
                  <li>
                     <a href="candidat.php?page=<?php echo base64_encode('pages/bord/lister');?>">> <span>Tableau de bord 2</span></a>
                  </li>
               </ul>
            </li>
            <li><a href="#"><i class="fa fa-group blue1_color"></i> <span>Prestataires</span></a></li>
            <!-- Compétences -->
            <li><a href="candidat.php?page=<?php echo base64_encode('pages/immig/ajout2');?>"><i class="fa fa-graduation-cap orange_color"></i> <span>Ajouter un candidat</span></a></li>
            <!-- Emplois -->
            ...
            <li>
               ...
               <ul class="collapse list-unstyled" id="element">
                  <li><a href="candidat.php?page=<?php echo base64_encode('pages/bord/lister');?>">> <span>identification personnelle</span></a></li>
                  <li><a href="candidat.php?page=<?php echo base64_encode('pages/bord/lister');?>">> <span>paiement et acheminement des documents</span></a></li>
                  <li><a href="candidat.php?page=<?php echo base64_encode('pages/bord/lister');?>">> <span>approbation du candidat</span></a></li>
                  <li><a href="candidat.php?page=<?php echo base64_encode('pages/bord/lister');?>">> <span>paiement et début de la procédure</span></a></li>

                  <li><a href="candidat.php?page=<?php echo base64_encode('pages/bord/test');?>">> <span>Test</span></a></li>
               </ul>
            </li>
            <li>
               <!-- Messages -->
