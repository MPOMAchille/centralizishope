                  ...
                  <ul class="list-unstyled components">
                     ...
                     <li>
                        ...
                        <ul class="collapse list-unstyled" id="elementi">
                           <li><a href="entreprise.php?page=<?php echo base64_encode('pages/bord/offre');?>">> <span>Enregistrer</span></a></li>
                           <li><a href="entreprise.php?page=<?php echo base64_encode('pages/bord/listeroffre');?>">> <span>Lister les Offres</span></a></li>
                           <li><a href="entreprise.php?page=<?php echo base64_encode('pages/bord/listercandidat');?>">> <span>Candidats</span></a></li>
