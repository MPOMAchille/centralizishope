...
if (isset($_GET['candidat_id'])) {
    ...
    // Récupérer toutes les informations du candidat en utilisant des alias pour éviter les collisions de noms
    $candidat_details_sql = "SELECT dd.*, ff.email AS user_email 
                             FROM candidats AS dd 
                             LEFT JOIN userss AS ff ON dd.user_id = ff.id  
                             WHERE dd.id = $candidat_id";
