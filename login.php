    ...
    if ($result->num_rows > 0) {
        ...
        if (password_verify($password, $row['password'])) {
            if ($row['statut'] == 1) {
                ...
                // Compte désactivé
                $error_message = "Votre compte a été désactivé. Contactez l'administrateur par email : contact@uricanada.com";
            }
        } else {
            // Mot de passe incorrect
            $error_message = "Le mot de passe ne correspond pas. Contactez l'administrateur par email : contact@uricanada.com";
        }
    } else {
