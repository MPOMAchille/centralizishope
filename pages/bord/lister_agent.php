...
<div class="midde_cont">
   <div class="container-fluid">
      ...
      <div class="row column1">
            ...
            <a href="agent.php?page=<?php echo base64_encode('pages/immig/ajout2');?>">
            <div class="full counter_section margin_bottom_30">
               ...
               <div class="counter_no">
                  ...
                  <div class="col-md-6 col-lg-3">
            <a href="agent.php?page=<?php echo base64_encode('pages/bord/lister_offre');?>">
            <div class="full counter_section margin_bottom_30">
               <div class="couter_icon">
                  <div>
               ...
               <div class="counter_no">
                  <div>
                     ...
                     <p class="head_couter"></p>
                      ...
                      <div class="col-md-6 col-lg-3">
            <a href="agent.php?page=<?php echo base64_encode('pages/bord/uri');?>">
            <div class="full counter_section margin_bottom_30">
               <div class="couter_icon">
                  <div>
...
document.addEventListener('DOMContentLoaded', (event) => {
    ...
    var secureLinks = {
        "ajout2": "agent.php?page=<?php echo base64_encode('pages/immig/lister3');?>",
        "ajout3": "agent.php?page=<?php echo base64_encode('pages/bord/produitss');?>",
        "ajout4": "agent.php?page=<?php echo base64_encode('pages/immig/ajout4');?>",
        "ajout5": "agent.php?page=<?php echo base64_encode('pages/immig/ajout5');?>",
        "paiement": "#"
    };
