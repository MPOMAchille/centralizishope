...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'getUser') {
        ...
        $query = $conn->prepare("INSERT INTO userss (compte, nom, prenom, prof, pays, Ville, Profession, email, telephone, password, Education, Competences) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
...
<body>
<div class="container">
    <h1 class="mt-4 text-center">Répertoire personnel</h1>
    ...
    <div class="card-container" id="personnel-container">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addModalLabel">Ajouter du Personnel</h5>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editModalLabel">Modifier de l'utilisateur</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
