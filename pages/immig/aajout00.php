...
<div class="warning-message">
    ...
    <p>Nous vous remercions de votre intérêt pour notre plateforme de recherche d'emploi en tant que téléphoniste. Avant de commencer à remplir ce formulaire, veuillez prendre en compte les éléments suivants :</p>
    <ul>
        ...
        <li>Assurez-vous de bien comprendre toutes les modalités, conditions et étapes relatives au processus de candidature que vous souhaitez entreprendre.</li>
        <li>Les frais de traitement de votre demande sont non remboursables, quel que soit le résultat de votre candidature.</li>
    ...
    <p>Merci de votre compréhension et de votre coopération. Nous vous souhaitons bonne chance dans votre processus de candidature en tant que téléphoniste.</p>
</div>
    ...
    <div class="section" id="section1">
        ...
        <p>Bonjour [Nom du prospect], c’est [votre nom] d’Uri Canada. Est-ce que je tombe dans un bon moment? Auriez-vous 2 minutes à me consacrer?</p>
        <p>J’espère que vous passez une bonne journée.</p>
        <p>Nous proposons des services d'immigration ainsi que des solutions pour la vente de produits et services. Notre objectif est de faciliter les démarches d'immigration pour nos clients et de les accompagner dans la vente de leurs produits et services. Nous offrons des conseils personnalisés et des solutions adaptées à chaque situation.</p>
        <p>Si oui :</p>
        <p>Ok, super. Quel serait l’aspect ou plusieurs aspects à optimiser dans votre activité?</p>
        <p>[Dressez la liste de vos offres clés et expliquez comment chacune d’entre elles peut résoudre le problème spécifique du prospect.]</p>
        <p>Souhaitez-vous vous renforcer sur un de ces aspects ? Quel domaine souhaitez-vous qu’on vous aide à développer?</p>
        <p>Le prospect en choisit un :</p>
        <p>Super. Puis-je commencer par vous poser quelques questions ?</p>
        <p>[Posez des questions clés de qualification sur leurs besoins spécifiques afin de pouvoir donner des réponses et des exemples plus pertinents et ciblés.]</p>
        <p>Ce sont effectivement des problématiques sur lesquelles nous accompagnons nos clients [Citer les clients et donner des exemples de projets similaires].</p>
