...
<div class="midde_cont">
   <div class="container-fluid">
      ...
      <div class="row column1">
            ...
            <a href="index5.php?page=<?php echo base64_encode('pages/immig/ajout00');?>">
...
document.addEventListener('DOMContentLoaded', (event) => {
    ...
    var secureLinks = {
      "ajout200": "index5.php?page=<?php echo base64_encode('pages/bord/tele');?>",
        "ajout20": "index5.php?page=<?php echo base64_encode('pages/immig/ajout20');?>",
        "ajout30": "index5.php?page=<?php echo base64_encode('pages/immig/ajout30');?>",
        "ajout40": "index5.php?page=<?php echo base64_encode('pages/immig/ajout40');?>",
        "ajout50": "index5.php?page=<?php echo base64_encode('pages/immig/ajout50');?>",
        "ajout5": "index5.php?page=<?php echo base64_encode('pages/immig/ajout5');?>",
        "paiement": "#"
    };
