...
// Session 1
$sql_session1 = "SELECT  * FROM  userss where  compte IN ('Entreprise', 'Agence') ";
...
FROM 
    userss u
INNER JOIN 
    formulaire_immigration_session2 f2 ON u.id = f2.user_id WHERE u.compte IN ('Entreprise', 'Agence', 'Agent') ";
...
FROM 
    userss u
INNER JOIN 
    formulaire_immigration_session3 f3 ON u.id = f3.user_id WHERE u.compte IN ('Entreprise', 'Agence', 'Agent')";
