...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($model) && !empty($name) && !empty($country) && !empty($city) && !empty($quartier) && !empty($email) && !empty($message) && !empty($package)) {
        ...
        $stmt = $conn->prepare("INSERT INTO orders (model, name, country, city, quartier, email, message, package, status, user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, 'en attente',?)");
        
        if ($stmt === false) {
            die("Erreur lors de la préparation de la requête : " . $conn->error);
        }

        $stmt->bind_param("ssssssssi", $model, $name, $country, $city, $quartier, $email, $message, $package, $userId);
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO formulaire_approche_visuelle (headerFormat, visualApproach, tone, propertiesDisplay, miniPub, logos, referenceList, advertisers, tools, boost, showAddress, showContacts, showHours, annonce_info, homepageDisplay, weeklyDisplay, document, user_id)
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, $userId)";
    
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("sssssssssssssssss", $headerFormat, $visualApproach, $tone, $propertiesDisplay, $miniPub, $logos, $referenceList, $advertisers, $tools, $boost, $showAddress, $showContacts, $showHours, $annonce_info, $homepageDisplay, $weeklyDisplay, $document);
...
<body>
    <div class="container mt-5">
        <div class="tabs">
            <button class="btn btn-secondary tab" onclick="showSection(0)">Section 1</button>
            <button class="btn btn-secondary tab" onclick="showSection(1)">Section 2</button>
            <button class="btn btn-secondary tab" onclick="showSection(2)">Section 3</button>
            <button class="btn btn-secondary tab" onclick="showSection(3)">Section 4</button>
        </div>
                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th class="debutant">Débutant</th>
                            <th class="simple">Simple</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td style="background-color: rgb(0,0,64); color: white;">Nombre de pages</td>
                        ...
                        <tr>
                            <td style="background-color: rgb(0,0,64); color: white;">Page d'accueil</td>
                            <td class="debutant">Une image en arrière plan</td>
                            <td class="simple">Une image en arrière plan</td>
                            <td class="premium">3 images en arrière plan</td>
                            <td class="pro">Une vidéo en arrière plan</td>
                        </tr>

                        <tr>
                            <td style="background-color: rgb(0,0,64); color: white;">Email professionnelle</td>
                            <td class="debutant"> 1</td>
                            <td class="simple"> 3</td>
                            <td class="premium"> 5</td>
                            <td class="pro"> 7</td>
                        ...
                        <tr>
                            <td style="background-color: rgb(0,0,64); color: white;">Ajout du logo et liens vers compte réseaux sociaux</td>
                        ...
                        <tr>
                            <td style="background-color: rgb(0,0,64); color: white;">Optimisation et référencement dans les moteur de recherche (Google,Bing)</td>
                        ...
                        <tr>
                            <td style="background-color: rgb(0,0,64); color: white;">Tableau de bord administrateur avec les statistiques utilisateurs</td>
                            <td class="debutant"><img style="width: 7%; height: 7%;" src="juste1.jpg"></td>
                            <td class="simple"><img style="width: 7%; height: 7%;" src="juste1.jpg"></td>
                            <td class="premium"><img style="width: 7%; height: 7%;" src="juste1.jpg"></td>
                            <td class="pro"><img style="width: 7%; height: 7%;" src="juste1.jpg"></td>
                        ...
                        <tr>
                            <td style="background-color: rgb(0,0,64); color: white;">Hébergement et nom de domaine offert pendant un an</td>
                            <td class="debutant"><img style="width: 7%; height: 7%;" src="juste1.jpg"></td>
                            <td class="simple"><img style="width: 7%; height: 7%;" src="juste1.jpg"></td>
                            <td class="premium"><img style="width: 7%; height: 7%;" src="juste1.jpg"></td>
                            <td class="pro"><img style="width: 7%; height: 7%;" src="juste1.jpg"></td>
                        ...
                        <tr>
                            <td style="background-color: rgb(0,0,64); color: white;">Site web personnalisable et modifiable (Couleurs, images, dispositions)</td>
                            <td class="debutant"><img style="width: 7%; height: 7%;" src="juste1.jpg"></td>
                            <td class="simple"><img style="width: 7%; height: 7%;" src="juste1.jpg"></td>
                            <td class="premium"><img style="width: 7%; height: 7%;" src="juste1.jpg"></td>
                            <td class="pro"><img style="width: 7%; height: 7%;" src="juste1.jpg"></td>
                        ...
                        <tr>
                            <td style="background-color: rgb(0,0,64); color: white;">Statistique des consultations des propriétés</td>
                            <td class="debutant"><img style="width: 7%; height: 7%;" src="juste1.jpg"></td>
                            <td class="simple"><img style="width: 7%; height: 7%;" src="juste1.jpg"></td>
                            <td class="premium"><img style="width: 7%; height: 7%;" src="juste1.jpg"></td>
                            <td class="pro"><img style="width: 7%; height: 7%;" src="juste1.jpg"></td>
                        ...
                        <tr>
                            <td style="background-color: rgb(0,0,64); color: white;"><strong> Espace publicitaire </td>
                            <td class="debutant"><em style="color: black;"> Sans ristourne</em> </td>
                            <td class="simple"> Avec ristourne</td>
                            <td class="premium"> Avec ristourne</td>
                            <td class="pro"> Avec ristourne</td>
                        </tr>



                        <tr>
                            <td style="background-color: rgb(0,0,64); color: white;">Création des comptes utilisateurs</td>
                        ...
                        <tr>
                            <td style="background-color: rgb(0,0,64); color: white;">Outils de calcul (Calculatrice de crédit immobilier, Calcul de l’hypothèque, évaluation et alerte immobilière)</td>
                        ...
                        <tr>
                            <td style="background-color: rgb(0,0,64); color: white;">Création des comptes pour courtiers et/ou agence immobilière</td>
                        ...
                        <tr>
                            <td style="background-color: rgb(0,0,64); color: white;">Intégration des outilsTableau de bord administrateur avec les statistiques utilisateurs, courtiers</td>
                        ...
                        <tr>
                            <td style="background-color: rgb(0,0,64); color: white;">Tracking Google</td>
                            <td class="debutant"><img style="width: 7%; height: 7%;" src="faux.jpg"></td>
                            <td class="simple"><img style="width: 7%; height: 7%;" src="faux.jpg"></td>
                            <td class="premium"><img style="width: 7%; height: 7%;" src="faux.jpg"></td>
                            <td class="pro"><img style="width: 7%; height: 7%;" src="juste1.jpg"></td>
