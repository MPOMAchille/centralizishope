...
if (isset($_GET['id'])) {
    ...
    // Récupérer les informations de l'utilisateur à partir du `id`
    ...
    $sql1 = "SELECT * FROM formulaire_immigration_session11 WHERE id = ?";
    ...
    $sql2 = "SELECT * FROM formulaire_immigration_session22 WHERE id = ?";
    ...
    $sql3 = "SELECT * FROM formulaire_immigration_session33 WHERE id = ?";
